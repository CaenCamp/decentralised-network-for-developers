...
class EventStatusType extends Enum
{
     ...
     */
    public const EVENT_CANCELLED = 'http://schema.org/EventCancelled';

    /**
     * @var string The event has been postponed and no new date has been set. The event's previousStartDate should be set.
     */
    public const EVENT_POSTPONED = 'http://schema.org/EventPostponed';
     ...
     */
    public const EVENT_RESCHEDULED = 'http://schema.org/EventRescheduled';
     ...
     */
    public const EVENT_SCHEDULED = 'http://schema.org/EventScheduled';
}
